...
module.exports = {
  theme: {
    extend: {
      colors: {
        'primary-5-color': 'var(--primary-color)',
        'primary-4-color': 'var(--primary-4-color)',
        'primary-6-color': 'var(--primary-6-color)',
        ...
        'on-primary-5-color': 'var(--on-primary-color)',
        'on-primary-4-color': 'var(--on-primary-4-color)',
        'on-primary-6-color': 'var(--on-primary-6-color)',
        ...
        'secondary-5-color': 'var(--secondary-color)',
        'secondary-4-color': 'var(--secondary-4-color)',
        'secondary-6-color': 'var(--secondary-6-color)',
        ...
        'accent-5-color': 'var(--accent-color)',
        'accent-4-color': 'var(--accent-4-color)',
        'accent-6-color': 'var(--accent-6-color)',
